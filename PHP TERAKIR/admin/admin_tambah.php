<?php
  ...
  {      
      ...
      $sql = "INSERT INTO `store`( `store_name`, `store_phone`, `store_address`, `store_latitude`, `store_longitude`, `store_delete`) VALUES (?,?,?,0,0,0)";
  ...
  {       
      ...
      $sql = "INSERT INTO `menu`(`menu_name`, `menu_desc`, `menu_sell_price`, `menu_discount`, `menu_stok`, `menu_img_ext`, `menu_out_of_stok`, `menu_delete`, `category_id`, `store_id`) VALUES (?,?,?,?,?,?,?,?,?,?)";
  ...
  {      
      ...
      {
          $sql = "INSERT INTO `user`( `email`, `password`, `uname`, `user_name`, `user_phone`, `user_role`, `user_delete`, `store_id`) VALUES (?,?,?,?,?,?,?,?)";
          $stmt = $mysqli->prepare($sql);
  ...
  {      
      ...
      if($aim == "kategori")
      {
          $sql = "INSERT INTO `banner`(`banner_name`, `banner_img_ext`, `banner_date_edited`, `banner_delete`, `category_aim_id`, `menu_aim_id`, `store_id`) VALUES (?,?,?,0,?,NULL,?)";          
      }
      else if($aim == "menu")
      {
          $sql = "INSERT INTO `banner`(`banner_name`, `banner_img_ext`, `banner_date_edited`, `banner_delete`, `category_aim_id`, `menu_aim_id`, `store_id`) VALUES (?,?,?,0,NULL,?,?)";      
