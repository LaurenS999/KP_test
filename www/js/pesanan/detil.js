...
function PesananDetail(id)
{
    app.request({
        method: "POST",
        url: "http://localhost/myorder/pesanan/pesanandetil.php",
        data: {
            uid : id
        },
        success: function(data) {                  
            ...
            {                       
                ...
                {                    
                    ...
                    var image = "menu_" + obj['menu'][i]['menu_id'].replace(" ","%20") + "." + obj['menu'][i]['menu_img_ext'];
...
{    
    app.request({
        method: "POST",
        url: "http://localhost/myorder/pesanan/driver.php",     
        data: {
...
function kirimKeDriver()
{
    ...
    else
    {
        app.request({
            method: "POST",
            url: "http://localhost/myorder/pesanan/kirimKeDriver.php",        
            data: {
            ...
            success: function(data) {        
                ...
                if (obj['status'] == true)
                {
                    TutupModal("modkonfirmasi_pesanan");
                    //app.views.main.router.navigate('/pesanan/');
                    BukaModal("modnotif_pesanandetil");
                    $$("#modnotif_pesanandetil_pesan").html("Berhasil Kirim Ke Driver");
                }
...
function ubahmenu()
{
    ...
    while(menuid != null)
    {
        ...
        app.request({
            method: "POST",
            url: "http://localhost/myorder/admin/ubahmenu.php",
            data: {
...
function button_pesanan(button)
{
    ...
    app.request({
        method: "POST",
        url: "http://localhost/myorder/pesanan/"+ button +".php",
        data: {
            transaction_id : id,
            pembayaran_id : pembayaran_id,
