...
function PesananDetail(id)
{
    app.request({
        method: "POST",
        url: "http://192.168.1.9/myorder/pesanan/pesanandetil.php",
        data: {
            uid : id
        },
...
{    
    app.request({
        method: "POST",
        url: "http://192.168.1.9/myorder/pesanan/driver.php",     
        data: {
...
function kirimKeDriver()
{
    ...
    else
    {
        app.request({
            method: "POST",
            url: "http://192.168.1.9/myorder/pesanan/kirimKeDriver.php",        
            data: {
...
function ubahmenu()
{
    ...
    while(menuid != null)
    {
        ...
        app.request({
            method: "POST",
            url: "http://192.168.1.9/myorder/admin/ubahmenu.php",
            data: {
...
function button_pesanan(button)
{
    ...
    app.request({
        method: "POST",
        url: "http://192.168.1.9/myorder/pesanan/"+ button +".php",
        data: {
            transaction_id : id,
            pembayaran_id : pembayaran_id,
