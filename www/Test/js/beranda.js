function load_beranda(e, page)
{
    ...
    if (localStorage.store_id === null || localStorage.store_id === "")
    {
        app.request({
            method: "POST",
            url: "http://192.168.1.9/myorder/beranda/load_cabang.php",
            data: {
                statInit : 'firstInit'
            },
...
function KategoriDetil_Beranda_Kasir(id) //LIST MENU PER KATEGORI
{
    ...
    app.request({
        method: "POST",
        url: "http://192.168.1.9/myorder/beranda/kategoridetail.php",
        data: {  
            kategori_id : id,
            cabang: localStorage.store_id
        },
...
function menu_promo()
{
    app.request({
        method: "POST",
        url: "http://192.168.1.9/myorder/beranda/menupromo.php",
        data: {
            cabang : localStorage.store_id
        },
        success: function(data) {
