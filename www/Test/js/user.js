function load_user(e, page)
{
    ...
    app.request({
        method: "POST",
        url: "https://localhost/myorder/user/profile.php",
        data: {  
...
{   
    ...
    else 
    {
        app.request({
            method: "POST",
            url: "http://192.168.1.9/myorder/user/changenama.php",
            data: {  
                user_id : localStorage.user_id,
                nama : nama
            },
...
function GantiTelepon()
{
    ...
    else
    {
        app.request({
            method: "POST",
            url: "http://192.168.1.9/myorder/user/changetelepon.php",
            data: {  
                user_id : localStorage.user_id,
                user_phone : telepon
            },
...
{    
    ...
    else
    {
        app.request({
            method: "POST",
            url: "http://192.168.1.9/myorder/user/changeemail.php",
            data: {  
                user_id : localStorage.user_id,
                email : email
            },
...
{    
    ...
    else
    {
        app.request({
            method: "POST",
            url: "http://192.168.1.9/myorder/user/changepass.php",
            data: {  
                user_id : localStorage.user_id,
